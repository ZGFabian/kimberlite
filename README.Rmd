...
This package is not more than a fork of [ochRe](https://github.com/ropenscilabs/ochRe) package. The goal of kimberlite is to create some named color palettes for ggplot2 and base R graphics. As the name suggest palettes were inspired by kimberlites and diamonds. 
